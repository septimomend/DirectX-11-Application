...
// Ãîëîâíà ôóíêö³ÿ ïðîãðàìè. Â³äáóâàþòüñÿ âñ³ ³í³ö³àë³çàö³¿, à ïîò³ì âèêîíóºòüñÿ öèêë îáðîáêè ïîâ³äîìëåíü
//--------------------------------------------------------------------------------------
...
// Äîïîì³æíà ôóíêö³ÿ äëÿ êîìï³ëþâàííÿ øåéäåð³â DX11
//--------------------------------------------------------------------------------------
...
// ²í³ö³àë³çàö³ÿ Direct3D ïðèñòðîþ
//--------------------------------------------------------------------------------------
HRESULT InitDevice()
{
	HRESULT hr = S_OK;
...
// Ïðîöåäóðà îáðîáêè ïîâ³äîìëåíü Windows
//--------------------------------------------------------------------------------------
...
void Render()
{
	...
	// Î÷èùåííÿ ðåíäåð-òàðãåòà
	float ClearColor[4] = { 0.0f, 0.9f, 0.5f, 1.0f }; // öâåò
	g_pImmediateContext->ClearRenderTargetView(g_pRenderTargetView, ClearColor);

	// Displaying the contents of the render-target
	// Âèâ³ä íà åêðàí âì³ñòó ðåíäåð-òàðãåòà
